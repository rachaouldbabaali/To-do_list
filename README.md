...
Overall, a to-do list project is a great way to practice working with JavaScript classes and methods, event listeners, and manipulating the DOM. It's also a useful tool for personal productivity and organization.
...
- **Added a user side feature to add a task with it's description using javascript classes.**
...
```sh
  cd my-folder
  git clone git@github.com:rachaouldbabaali/To-do_list.git
```
...
Feel free to check the [issues page](https://github.com/rachaouldbabaali/To-do_list/issues).
...
This project is [MIT](https://github.com/rachaouldbabaali/To-do_list/blob/main/LICENSE) licensed.
